        ...
        <div class="card shadow mb-4 mt-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">
                    ...
                    <a style="float: right" class="btn btn-outline-danger" href="{{ route('modules.guru.index') }}">
                        <i class="fa fa-sign-out-alt"></i> Kembali
                    </a>
                </h6>
            </div>
            <form action="{{ route('modules.guru.update', ['id' => $edit->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method("PUT")
                <div class="card-body">
                    <div class="row">
                        <div class="col mb-2">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" id="nama" placeholder="Masukkan Nama" class="form-control" value="{{ $edit->users->nama }}">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="username" class="form-label"> Username </label>
                                <input type="text" name="username" id="username" placeholder="Masukkan Username" class="form-control" value="{{ $edit->users->username }}">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="nip" class="form-label"> NIP </label>
                                <input type="text" name="nip" id="nip" placeholder="Masukkan NIP" class="form-control" value="{{ $edit->nip }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
