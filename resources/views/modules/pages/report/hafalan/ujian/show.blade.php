...
@push('modules-title', 'Detail Hafalan Harian ' . $detail->siswa->nama . " - " . $detail->siswa->kelas->jenjang)
...
@push('modules-content')
    ...
    <div class="container-fluid">
        ...
        <a href="{{ route('modules.report.hafalan.ujian.index') }}" class="btn btn-outline-danger btn-sm btn-block mb-4">
            Kembali
        </a>
    </div>
@endpush
